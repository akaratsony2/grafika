...
/* Tömb a négyzet pontjainak és azok színeinek tárolásához. */
/* Array for storing the points and colors of a rectangle. */
float vertices[] = {
	// positions           // color
...
void init(GLFWwindow* window) {
	...
	generateCirclePoints(glm::vec2(0.0f, 0.0f), 0.1f, 6);
	...
	/* Szín attribútum beállítása és engedélyezése. */
	...
	/* Tároljuk el a vertex shader transform objektumának helyét. */
	/* Store the location of transform object of the vertex shader. */
